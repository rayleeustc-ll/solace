...
public class QueueProducer {
    ...
    public static void main(String... args) throws JCSMPException, InterruptedException {
        ...
        properties.setProperty(JCSMPProperties.HOST,"szhpc6287");     // host:port
        properties.setProperty(JCSMPProperties.USERNAME, "lelewang"); // client-username
        properties.setProperty(JCSMPProperties.VPN_NAME,  "default"); // message-vpn
        properties.setProperty(JCSMPProperties.PASSWORD, "lelewang"); // client-password
